...
func indexRepoHelper(t *testing.T) string {
	...
	writeFile(t, filepath.Join(repo, "tsconfig.base.json"), "{\n  \"compilerOptions\": {\n    \"baseUrl\": \".\",\n    \"paths\": {\n      \"#shared/*\": [\"web/*\"]\n    }\n  }\n}\n")
	...
	writeFile(t, filepath.Join(repo, "packages", "app", "tsconfig.json"), "{\n  \"extends\": \"../../tsconfig.base.json\",\n  \"compilerOptions\": {\n    \"baseUrl\": \".\",\n    \"paths\": {\n      \"@app/*\": [\"src/*\"]\n    }\n  }\n}\n")
	writeFile(t, filepath.Join(repo, "packages", "app", "src", "util.ts"), "export function util() { return 'ok' }\n")
	writeFile(t, filepath.Join(repo, "packages", "app", "src", "feature.ts"), "import { util } from '@app/util'\nimport { session } from '#shared/session'\n\nexport function feature() { return util() + session() }\n")
	...
	writeFile(t, filepath.Join(repo, "src", "pkgsrc", "__init__.py"), "")
	writeFile(t, filepath.Join(repo, "src", "pkgsrc", "helper.py"), "def helper():\n    return 'ok'\n")
	writeFile(t, filepath.Join(repo, "src", "pkgsrc", "app.py"), "from pkgsrc.helper import helper\n\ndef app():\n    return helper()\n")
